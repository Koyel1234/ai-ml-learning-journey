...
class Patient(BaseModel):
    ...
    mame: Annotated[str, Field(..., description="Name of the patient")]
    city: Annotated[str, Field(..., description="City where the patient is living")]
    age: Annotated[int, Field(..., gt=0, lt=120, description="Age of the patient")]
    gender: Annotated[Literal['male', 'female', 'others'], Field(..., description="Gender of the patient")]
    height: Annotated[float, Field(..., gt=0, description="Hright of the patient in mtrs")]
...
class PatientUpdate(BaseModel):
    mame: Annotated[Optional[str], Field(default=None, description="Name of the patient")]
    ...
    gender: Annotated[Optional[Literal['male', 'female', 'others']], Field(default=None, description="Gernder of the patient")]
