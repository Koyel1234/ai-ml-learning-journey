## Virtual Environment
- Create a virtual environment via below command:
    `python -m venv \<venv_name\>
- It will create a folder of \<venv_name\> in current directory.
- Activate the virtual environemnt via below command:
...
- Post creating the virtual environment install all libraries via below command:
