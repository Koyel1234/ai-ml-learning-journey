- We will see integration of LangSmith by using LangChain first then with LangGraph.
- We will test a. Normal workflow, b. RAG based workflow, c. AI Agent.

# first we added necessary env variable in .env file
